...
data class SignupRequest(
    ...
    @field: Size(min = 6, max = 20, message = "아이디는 6자 이상 20자 이하로 입력해주세요.")
    @field: Pattern(regexp = "^[a-z0-9]+$", message = "아이디는 영문 소문자와 숫자만 사용 가능합니다.")
    ...
    @field: Pattern(regexp = "^[a-zA-Z0-9가-힣]+$", message = "닉네임은 한글, 영문자, 숫자만 사용 가능합니다.")
    val nickname: String
)
